...
class ThumbsUpAni {
    ...
    loadImages() {
        const images = ['o_200522031835like1.png', 'o_200522031842like2.png', 'o_200522031850like3.png', 'o_200522031859like4.png', 'o_200522031907like5.png', 'o_200522031915like6.png'];
        const promiseAll = [];
        images.forEach((src) => {
