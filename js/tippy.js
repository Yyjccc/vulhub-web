!
    function (t, e) {
        ...
        function E(t, e, n) {
            var i = e + "EventListener";["transitionend", "webkitTransitionEnd"].forEach((function (e) {
                t[i](e, n)
            }))
        }
        var T = {
        ...
        function O() {
            ...
            t - A < 20 && (T.isTouch = !1, document.removeEventListener("mousemove", O)),
                A = t
        }
        function L() {
        ...
        function V(t, e) {
            var n = Object.assign({},
                ...
                e.ignoreAttributes ? {} : function (t, e) {
                    return (e ? Object.keys(M(Object.assign({},
                        D, {
                        plugins: e
        ...
        function j(t) {
            var e = v();
            return !0 === t ? e.className = "tippy-arrow" : (e.className = "tippy-svg-arrow", m(t) ? e.appendChild(t) : R(e, t)),
                e
        }
        function P(t, e) {
        ...
        function S(t) {
            ...
            function r(n, i) {
                ...
                i.theme ? o.setAttribute("data-theme", i.theme) : o.removeAttribute("data-theme"),
                    ...
                    i.arrow ? s ? n.arrow !== i.arrow && (o.removeChild(s), o.appendChild(j(i.arrow))) : o.appendChild(j(i.arrow)) : s && o.removeChild(s)
            }
        ...
        var B = 1,
            ...
            U = [];
        function N(e, n) {
            var a, u, m, h, b, A, C, O, L = V(e, Object.assign({},
                D, {},
                M(n))),
                k = !1,
                R = !1,
                ...
                z = {
                    ...
                    show: function () {
                        ...
                        z.state.isVisible = !0,
                            Q() && (W.style.visibility = "visible");
                        nt(),
                            ct(),
                            z.state.isMounted || (W.style.transition = "none");
                        if (Q()) {
                            var a = tt(),
                                p = a.box,
                                u = a.content;
            ...
            function it(t, e, n) {
                var i; (void 0 === n && (n = !0), $.forEach((function (n) {
            ...
            function st(t) {
                if (!(T.isTouch && (j || "mousedown" === t.type) || z.props.interactive && W.contains(t.target))) {
                    ...
                    } else it("onClickOutside", [z, t]); !0 === z.props.hideOnClick && (k = !1, z.clearDelayTimeouts(), z.hide(), R = !0, setTimeout((function () {
                        R = !1
            ...
            function gt(t) {
                ...
                if (z.state.isEnabled && !xt(t) && !R) {
                    ...
                    h = t,
                        C = t.currentTarget,
                        ot(),
                        !z.state.isVisible && g(t) && H.forEach((function (e) {
                            return e(t)
                        })),
                        "click" === t.type && (z.props.trigger.indexOf("mouseenter") < 0 || k) && !1 !== z.props.hideOnClick && z.state.isVisible ? n = !0 : At(t),
                        "click" === t.type && (k = !n),
                        n && !i && Ct(t)
                }
            }
            ...
            function wt() {
                ...
                var n = z.props,
                    ...
                    },
                    {
                        ...
                        fn: function (t) {
                            var e = t.state;
                            if (Q()) {
                                var n = tt().box;["placement", "reference-hidden", "escaped"].forEach((function (t) {
                ...
                Q() && p && c.push({
                    ...
                    z.popperInstance = t.createPopper(u, W, Object.assign({},
                        i, {
                        placement: r,
                        onFirstUpdate: A,
                        modifiers: c
            ...
            fn: function (t) {
                ...
                function u(n) {
                    ...
                    var r = !n.target || e.contains(n.target),
                        ...
                        c = a - u.left,
                        f = s - u.top; !r && t.props.interactive || t.setProps({
            ...
            fn: function (t) {
                ...
                function a() {
                    var s = i("reference") ? (t.popperInstance ? t.popperInstance.state.elements.reference : e).getBoundingClientRect() : null,
                        p = i("popper") ? n.getBoundingClientRect() : null; (s && q(r, s) || p && q(o, p)) && t.popperInstance && t.popperInstance.update(),
                            r = s,
                            o = p,
        ...
        return e &&
            ...
            X.roundArrow = '<svg width="16" height="6" xmlns="http://www.w3.org/2000/svg"><path d="M0 6s1.796-.013 4.67-3.615C5.851.9 6.93.006 8 0c1.07-.006 2.148.887 3.343 2.385C14.233 6.005 16 6 16 6H0z"></svg>',
            X
    }));
